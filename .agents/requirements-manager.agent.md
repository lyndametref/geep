...
name: "Requirements Manager Agent"
tools: [read, search, edit]
argument-hint: "Goal or scope, for example: 'Create a new requirement for individual management about recording the color pattern of sheep.' or 'Validate all requirements for consistency and traceability.'"
user-invocable: true
---
