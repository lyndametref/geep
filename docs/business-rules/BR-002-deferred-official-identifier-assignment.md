...
Based on requirement [REQ-01.003](../requirements/business/REQ-01.003.md) — For individual entries without an assigned BDTA number yet, the system allows later BDTA assignment, this rule allows shepherds to create an individual record during field operations (e.g., at birth) without having the Official Identifier at hand. The Official Identifier can be recorded in a subsequent update, reducing data entry friction at the point of capture.
