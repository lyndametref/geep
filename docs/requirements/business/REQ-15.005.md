...
## Description
The system must allow the flock manager to define custom waiting delay types that specify a duration associated with a given intervention type (see [REQ-13.004](REQ-13.004.md) for quarantine periods). Waiting delays appear on the individual's journal and calendar view.
...
- Waiting delays appear on the individual's chronological journal ([REQ-04.006](REQ-04.006.md), [REQ-13.005](REQ-13.005.md)).
