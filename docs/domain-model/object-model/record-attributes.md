...
| `recordedAt` | Timestamp (UTC) | Yes | ISO-8601 UTC timestamp ending with `Z` (e.g. `2024-06-01T10:00:00Z`). Used for chronological journal ordering. | REQ-04, REQ-13, BR-016 |
