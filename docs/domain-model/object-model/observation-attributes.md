...
| `content` | JSON (Structured Data) | Yes | UTF-8 encoded JSON string. Payload structure defined in [`docs/specs/data-types/observation-content-schema.json`](../../specs/data-types/observation-content-schema.json). | REQ-04, REQ-04.001, REQ-04.007, REQ-15.001, BR-019 |
