...
| `sourceRecordId` | Long | No | Logical FK to the Record that derived this PlannedTask. | BR-012, BR-022, BR-014 |
...
| `reminderDate` | Timestamp (UTC) | No | Date when a notification reminder should be shown. May be before `dueDate`. | BR-022 |
