# SEC-010 Mobile-Specific Security Controls
...
- Distribution via APK side-loading (not Play Store in MVP). No dependency on Google Play Services.
...
- docs/specs/MOBILE_SECURITY_POLICY.md §4
- docs/requirements/non-functional/NFR-04.001.md
