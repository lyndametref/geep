...
Mobile-specific layout and navigation. All UI workflows follow the specs defined in the sibling view files ([`calendar-view.md`](calendar-view.md), [`journal-view.md`](journal-view.md), etc.) — this document only covers mobile adaptations.
...
- **Upcoming events** section: next 5 calendar events (tasks due, predicted events, reminders) ordered by date (see [`calendar-view.md`](calendar-view.md))
...
Defined in [`flock-view.md`](flock-view.md)

## Individual detail view

Accessed when clicking on an individual in the flock view or in calendar view.

Defined in [`individual-view.md`](individual-view.md)

## Calendar view

Defined in [`calendar-view.md`](calendar-view.md)
