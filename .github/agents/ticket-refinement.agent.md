...
- CHECK conformity with `specs/` and `docs/`, and align the ticket if needed.
...
- DO NOT make any assumptions that cannot be traced to `specs/`, `docs/`, or linked backlog artifacts.
